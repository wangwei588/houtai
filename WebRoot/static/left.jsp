...
<div id="sidebar" class="sidebar">
				...
				<ul class="nav nav-list">
					<li class="active">
						<a href="${pageContext.request.contextPath }/guan/main/index">
				...
				<c:if test="${menu1.hasMenu && '1' == menu1.MENU_STATE}">
					<li class="twoList"  id="lm${menu1.MENU_ID }">
						...
						<c:forEach items="${menu1.subMenu}" var="menu2">
							...
							<li class="" id="z${menu2.MENU_ID }">
								<a style="cursor:pointer;" <c:if test="${not empty menu2.MENU_URL && '#' != menu2.MENU_URL}">target="mainFrame" onclick="siMenu('${menu2.MENU_NAME }')"</c:if><c:if test="${'[]' != menu2.subMenu}"> class="dropdown-toggle"</c:if>>
								...
								<ul class="submenu">
									...
									<c:if test="${menu3.hasMenu && '1' == menu3.MENU_STATE}">
										<li class="threeList" id="m${menu3.MENU_ID }">
											<a style="cursor:pointer;" <c:if test="${not empty menu3.MENU_URL && '#' != menu3.MENU_URL}">target="mainFrame" onclick="siMenu('${menu2.MENU_NAME }')"</c:if><c:if test="${'[]' != menu3.subMenu}"> class="dropdown-toggle"</c:if>>
											...
											<ul class="submenu">
												...
												<li class="" id="n${menu4.MENU_ID }">
													...
													<a style="cursor:pointer;" target="mainFrame" target="mainFrame" onclick="siMenu('${menu4.MENU_NAME }')">
													</c:if>
													<c:if test="${'[]' == menu4.subMenu}">
